...
void Dijkstra(int S){
	...
	for(int i = 0;i <= n;i++) distancia[i] = INFINITO; // definimos todas as distancias como infinito, exceto a de S.
...
int main(){
	...
	Dijkstra(0); // rodamos o Dijkstra
	cout << distancia[n] << endl; // imprimimos a resposta
